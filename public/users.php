                ...
                <div class="p-4">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <h2 class="mb-0"><i class="fas fa-user-cog me-2"></i>Quản lý người dùng</h2>
                        </div>
    ...
    <div class="offcanvas offcanvas-start offcanvas-sidebar" tabindex="-1" id="mobileSidebar" aria-labelledby="mobileSidebarLabel">
        ...
        <div class="offcanvas-body p-0">
            ...
            <nav class="nav flex-column px-3">
                ...
                <?php if (canAccess(PERMISSION_MANAGE_USERS)): ?>
                <a class="nav-link active" href="users.php" data-bs-dismiss="offcanvas">
                    <i class="fas fa-user-cog me-2"></i>Quản lý người dùng
                </a>
                <?php endif; ?>
                
                <a class="nav-link" href="profile.php" data-bs-dismiss="offcanvas">
                    <i class="fas fa-user me-2"></i>Thông tin cá nhân
                </a>
