...
$hasPermission = hasPermission(PERMISSION_EDIT_SUBJECTS);

$subjectController = new SubjectController();
$id = $_GET['id'] ?? 0;
$subject = $hasPermission ? $subjectController->getSubjectById($id) : null;
...
if ($hasPermission && $_SERVER['REQUEST_METHOD'] == 'POST') {
    if (!isset($_POST['csrf_token']) || !verifyCSRFToken($_POST['csrf_token'])) {
        ...
        if (empty($data['name'])) {
            ...
            $result = $subjectController->updateSubject($id, $data);
            if ($result['success']) {
                $success = $result['message'];
                $subject = $subjectController->getSubjectById($id);
                $data = $subject;
            } else {
...
<head>
    ...
    <title>Sửa môn học - Hệ thống quản lý sinh viên</title>
                ...
                <div class="p-4">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <h2 class="mb-0"><i class="fas fa-edit me-2"></i>Sửa môn học</h2>
                        </div>
                            ...
                            <form method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="name" name="name"
                                        ...
                                        placeholder="Ví dụ: Toán cao cấp" required>
                                </div>

                                <div class="mb-3">
                                    <label for="credits" class="form-label">Số tín chỉ</label>
                                    <input type="number" class="form-control" id="credits" name="credits"
                                        value="<?php echo $data['credits'] ?? 3; ?>" min="1" max="10">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" id="status" name="status">
                                        ...
                                        <option value="inactive" <?php echo ($data['status'] == 'inactive') ? 'selected' : ''; ?>>Ngừng</option>
                                    </select>
                                </div>
