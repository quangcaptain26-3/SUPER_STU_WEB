...
$hasPermission = hasPermission(PERMISSION_ADD_SUBJECTS);
...
if ($hasPermission && $_SERVER['REQUEST_METHOD'] == 'POST') {
    if (!isset($_POST['csrf_token']) || !verifyCSRFToken($_POST['csrf_token'])) {
        ...
        if (empty($data['name'])) {
            ...
            $result = $subjectController->addSubject($data);
            if ($result['success']) {
...
<head>
    ...
    <title>Thêm môn học - Hệ thống quản lý sinh viên</title>
                ...
                <div class="p-4">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <div class="d-flex align-items-center gap-3">
                            ...
                            <h2 class="mb-0"><i class="fas fa-plus me-2"></i>Thêm môn học mới</h2>
                        </div>
                            ...
                            <form method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" id="status" name="status">
                                        <option value="active" <?php echo (($data['status'] ?? 'active') == 'active') ? 'selected' : ''; ?>>Hoạt động</option>
