...
// Yêu cầu người dùng phải có quyền chỉnh sửa điểm
requirePermission(PERMISSION_EDIT_SCORES);
...
// Lấy ID điểm từ tham số GET, mặc định là 0 nếu không có
$scoreId = $_GET['id'] ?? 0;
// Lấy thông tin điểm theo ID
$score = $scoreController->getScoreById($scoreId);

// Nếu không tìm thấy điểm
if (!$score) {
    // Chuyển hướng về trang danh sách với thông báo lỗi
    header('Location: list.php?error=score_not_found');
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (!isset($_POST['csrf_token']) || !verifyCSRFToken($_POST['csrf_token'])) {
        ...
        if (empty($data['student_id']) || empty($data['subject_id']) || empty($data['semester'])) {
            ...
            // Nếu tất cả đều hợp lệ, gọi phương thức updateScore để cập nhật điểm
            ...
            if ($result['success']) {
                ...
                // Cập nhật dữ liệu điểm để hiển thị
...
<head>
    ...
    <title>Sửa điểm - Hệ thống quản lý sinh viên</title>
            ...
            <div class="col-md-9 col-lg-10 main-content">
                <div class="p-4">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <h2><i class="fas fa-edit me-2"></i>Sửa điểm</h2>
                        ...
                        <div class="col-lg-8">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="mb-0">
                                        <i class="fas fa-chart-line me-2"></i>Thông tin điểm
                                        <span class="badge bg-primary ms-2">ID: <?php echo $score['id']; ?></span>
                                    </h5>
                                </div>
                                <div class="card-body">
                                    <?php if ($error): ?>
                                    ...
                                    <form method="POST" id="scoreForm">
                                                ...
                                                <select class="form-control" id="subject_id" name="subject_id" required>
                                                    ...
                                                    <?php foreach ($subjects as $subject): ?>
                                                        <option value="<?php echo $subject['id']; ?>"
                                                            <?php echo (($score['subject_id'] ?? '') == $subject['id']) ? 'selected' : ''; ?>>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-control" id="semester" name="semester" required>
                                                ...
                                                <option value="HK1-2024" <?php echo ($score['semester'] == 'HK1-2024') ? 'selected' : ''; ?>>HK1-2024</option>
                                                <option value="HK2-2024" <?php echo ($score['semester'] == 'HK2-2024') ? 'selected' : ''; ?>>HK2-2024</option>
                                                <option value="HK1-2023" <?php echo ($score['semester'] == 'HK1-2023') ? 'selected' : ''; ?>>HK1-2023</option>
                                    ...
                                    <div class="row text-center">
                                        <div class="col-6">
                                            <div class="border-end">
                                                ...
                                                <p class="mb-0 small"><?php echo htmlspecialchars($score['msv']); ?></p>
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <h6 class="text-muted">Môn học</h6>
                                            <p class="mb-0 small"><?php echo htmlspecialchars($score['subject']); ?></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
